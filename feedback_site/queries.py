...
class DonationSQL:
    ...
    @classmethod
    def exists_by_email_and_confirmation(cls, email: str, confirmation_no: str) -> str:
    ...
    @classmethod
    def exists_by_token(cls, token: str) -> str:
...
class FeedbackSQL:
    ...
    @classmethod
    def exists_by_confirmation(cls, confirmation_no: str) -> str:
